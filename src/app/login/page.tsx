  ...
  return (
    <main className="w-full h-full flex items-center justify-center" style={{
      ...
      <div className="absolute left-0 top-0">
        <Image src="/mikko-tail-2.svg" alt="Mikko" height={200} width={175} />
      </div>
      <div className="absolute right-0 bottom-0">
        <Image src="/mikko-tail.svg" alt="Mikko" height={40} width={255} />
      </div>
      <div className="h-full md:h-fit py-11 flex flex-col items-center justify-between gap-16">
        <Image src="/logo-light.svg" alt="Mikko" height={70} width={255} />
