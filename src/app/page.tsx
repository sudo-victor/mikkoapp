    ...
    <>
      ...
      <section className="w-full px-7 py-11 flex flex-col gap-5">
        ...
        <div className="grid gap-[6px]">
          <CardInfo
            title="Fale sobre sua meta financeira"
            description="Descreva onde você quer chegar financeiramente."
            Icon={TbTargetArrow}
          />
          <CardInfo
            title="O Mikko analisa seus gastos"
            description="É feita uma breve análise sobre seu perfil financeiro."
            Icon={FiSearch}
          />
          <CardInfo
            title="No final, tenha um planejamento completo"
            description="Alinhamos seu objetivo e seu perfil em um planejamento completamente personalizado."
            Icon={PiStrategy}
          />
        </div>
